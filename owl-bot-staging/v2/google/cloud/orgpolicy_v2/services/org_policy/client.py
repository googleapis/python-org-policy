...
class OrgPolicyClient(metaclass=OrgPolicyClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "orgpolicy.{UNIVERSE_DOMAIN}"
    ...
    @staticmethod
    def custom_constraint_path(organization: str,custom_constraint: str,) -> str:
        """Returns a fully-qualified custom_constraint string."""
        return "organizations/{organization}/customConstraints/{custom_constraint}".format(organization=organization, custom_constraint=custom_constraint, )
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = OrgPolicyClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = OrgPolicyClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = OrgPolicyClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            OrgPolicyClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, OrgPolicyTransport, Callable[..., OrgPolicyTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = OrgPolicyClient._read_environment_variables()
        self._client_cert_source = OrgPolicyClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = OrgPolicyClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, OrgPolicyTransport)
        if transport_provided:
            ...
            self._transport = cast(OrgPolicyTransport, transport)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[OrgPolicyTransport], Callable[..., OrgPolicyTransport]] = (
    ...
    def create_custom_constraint(self,
    ...
    def update_custom_constraint(self,
    ...
    def get_custom_constraint(self,
    ...
    def list_custom_constraints(self,
    ...
    def delete_custom_constraint(self,
