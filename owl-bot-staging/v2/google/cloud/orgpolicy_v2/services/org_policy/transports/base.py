...
class OrgPolicyTransport(abc.ABC):
    ...
    @property
    def list_constraints(self) -> typing.Callable[
            [orgpolicy.ListConstraintsRequest],
            typing.Union[
                orgpolicy.ListConstraintsResponse,
                typing.Awaitable[orgpolicy.ListConstraintsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def list_policies(self) -> typing.Callable[
            [orgpolicy.ListPoliciesRequest],
            typing.Union[
                orgpolicy.ListPoliciesResponse,
                typing.Awaitable[orgpolicy.ListPoliciesResponse]
            ]]:
        raise NotImplementedError()
    ...
    def get_policy(self) -> typing.Callable[
            ...
            typing.Union[
                orgpolicy.Policy,
                typing.Awaitable[orgpolicy.Policy]
            ]]:
        raise NotImplementedError()

    @property
    def get_effective_policy(self) -> typing.Callable[
    ...
    @property
    def create_policy(self) -> typing.Callable[
    ...
    @property
    def delete_policy(self) -> typing.Callable[
