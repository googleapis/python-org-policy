...
class OrgPolicyRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_custom_constraint(self, request: orgpolicy.CreateCustomConstraintRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[orgpolicy.CreateCustomConstraintRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_create_policy(self, request: orgpolicy.CreatePolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[orgpolicy.CreatePolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_delete_custom_constraint(self, request: orgpolicy.DeleteCustomConstraintRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[orgpolicy.DeleteCustomConstraintRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_delete_policy(self, request: orgpolicy.DeletePolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[orgpolicy.DeletePolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_custom_constraint(self, request: orgpolicy.GetCustomConstraintRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[orgpolicy.GetCustomConstraintRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_effective_policy(self, request: orgpolicy.GetEffectivePolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[orgpolicy.GetEffectivePolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_policy(self, request: orgpolicy.GetPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[orgpolicy.GetPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_constraints(self, request: orgpolicy.ListConstraintsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[orgpolicy.ListConstraintsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_custom_constraints(self, request: orgpolicy.ListCustomConstraintsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[orgpolicy.ListCustomConstraintsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_policies(self, request: orgpolicy.ListPoliciesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[orgpolicy.ListPoliciesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_update_custom_constraint(self, request: orgpolicy.UpdateCustomConstraintRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[orgpolicy.UpdateCustomConstraintRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_update_policy(self, request: orgpolicy.UpdatePolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[orgpolicy.UpdatePolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
